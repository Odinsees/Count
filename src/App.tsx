...
const App = () => {
  ...
  let startValue = useSelector<AppRootStateType, number>(
    (state) => state.counter.startValue
  );
  let maxValue = useSelector<AppRootStateType, number>(
    (state) => state.counter.maxValue
  );
  const count = useSelector<AppRootStateType, number>(
    (state) => state.counter.value
  );
  let greeting = useSelector<AppRootStateType, boolean>(
    (state) => state.counter.greeting
  );
